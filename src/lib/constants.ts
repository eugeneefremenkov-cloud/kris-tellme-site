  ...
  prenatal: {
    ...
    self: {
      ...
      preorder: {
        ...
        price: "3 900 ₽",
        startDate: "июль 2026",
        note: "Записываем курс — старт в июле 2026. Сейчас доступен предзаказ по специальной цене.",
        tgMessage:
          "Здравствуйте, Кристина! Хочу забронировать предзаказ самостоятельного тарифа «Подготовка к родам».",
      },
    },
    personal: {
      label: "Персональный",
  ...
  postnatal: {
    ...
    self: {
      ...
      preorder: {
        ...
        note: "Записываем курс — старт в июле 2026. Сейчас доступен предзаказ по специальной цене.",
        tgMessage:
          "Здравствуйте, Кристина! Хочу забронировать предзаказ самостоятельного тарифа «Сопровождение после родов».",
      },
    },
    personal: {
      label: "Персональный",
