...
export const SERVICES = {
  program: {
    title: "Программа «Подготовка к родам»",
    price: "17 900 ₽",
    pricePer: "за 4 встречи (экономия 1 700 ₽)",
    duration: "4 встречи · 4 недели",
    description:
      "Системная подготовка к родам: уйти от «накручиваю сценарии» к «знаю, что делаю и у меня есть инструменты». Подходит, если до родов 4+ недели и хочется не разовой консультации, а сопровождения.",
    tgMessage: "Здравствуйте, Кристина! Хочу записаться на программу «Подготовка к родам».",
  },
  consultation: {
    title: "Консультация 50 минут",
    price: "4 900 ₽",
    pricePer: "за встречу",
    duration: "1 встреча · 50 минут",
    description:
      "Точечная работа по одному запросу: один страх, один разговор с близкими, одно решение. Подходит для второго мнения, разовой поддержки или ситуативной помощи.",
  ...
  makExpress: {
    ...
    description:
      "Расшифровка метафорической карты — 2 голосовых сообщения в Telegram или ВК. Лёгкий способ познакомиться, если страшно сразу идти на полноценную консультацию.",
